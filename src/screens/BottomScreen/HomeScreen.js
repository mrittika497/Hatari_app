...
const HomeScreen = () => {
  ...
  const renderHeader = () => (
    <>
      ...
      <SectionDivider
        title={isVeg ? "Top Veg Picks" : "Top Non-Veg Picks"}
      />
    </>
  );
        ...
        <View style={styles.details}>
          ...
          <View style={styles.row}>
            <View
              style={[
                styles.typeBox,
                { borderColor: (String(dataItem.type || "").toLowerCase() === "veg" ? "green" : "red") },
              ]}
            >
              <View
                style={[
                  styles.typeDot,
                  { backgroundColor: (String(dataItem.type || "").toLowerCase() === "veg" ? "green" : "red") },
                ]}
              />
            </View>
