...
const HomeScreen = () => {
  ...
  const experiences = [
    ...
    { id: 2, title: 'Dine in', img: require("../../assets/images/dineH.png") },
    { id: 3, title: 'Takeaway', img: require("../../assets/images/takeawayH.png") },
  ];

  const categories = [
    { id: 1, name: 'Chicken', img: require("../../assets/images/remove/Chicken.png") },
    { id: 2, name: 'Fish', img: require("../../assets/images/remove/Chicken.png") },
    { id: 3, name: 'Mutton', img: require("../../assets/images/remove/Chicken.png") },
    { id: 4, name: 'Prawns', img: require("../../assets/images/remove/Chicken.png") },
  ];
  ...
  return (
    <DashboardScreen scrollable={false}>
      ...
      <View style={styles.header}>
        ...
        <Image source={require("../../assets/images/location.png")} style={styles.logo} />
        <Text style={styles.locationText}>Hatari (Barisha Outlets)</Text>
        <Image source={require("../../assets/images/downarrow.png")} style={styles.logo}/>
        </View>
        <Image
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.experienceContainer}>
          {experiences.map((item) => (
            <TouchableOpacity
              ...
              onPress={() => setSelectedExperience(item.title)}
            >
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.bannerScroll}>
          {loading
            ? [1, 2, 3].map((i) => (
              <ShimmerPlaceholder
                key={i}
                style={{ width: 300, height: 130, borderRadius: 10, marginRight: 10 }}
              />
            ))
        ...
        {loading ? (
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity style={styles.categoryCard} onPress={() => { Navigation.navigate('CatItemScreen') }}>
        ...
        {loading ? (
          [1, 2].map((i) => (
            <View key={i} style={[styles.foodCard, { alignItems: 'center' }]}>
              <ShimmerPlaceholder style={{ width: 80, height: 80, borderRadius: 10 }} />
              <View style={{ flex: 1, marginLeft: 10 }}>
                <ShimmerPlaceholder style={{ width: '60%', height: 12, marginBottom: 8 }} />
                <ShimmerPlaceholder style={{ width: '40%', height: 12, marginBottom: 8 }} />
...
const styles = StyleSheet.create({
  ...
  searchContainer: { flexDirection: 'row', justifyContent: 'space-between', marginVertical: 20 },
  searchBox: {
    height: 46,
    width: '75%',
    borderWidth: 1,
  ...
  experienceContainer: { flexDirection: 'row', justifyContent: 'space-around', marginVertical: 10 },
  experienceCard: {
    flexDirection: 'row',
    alignItems: 'center',
    borderWidth: 1,
  ...
  bannerImage: { width: 300, height: 130, borderRadius: 10, marginRight: 10, marginBottom: 15 },

  categoryCard: { alignItems: 'center', marginRight: 15 },
  categoryImage: { width: 80, height: 80, borderRadius: 50, borderWidth: 1, borderColor: '#eee' },
  ...
  ratingBox: { backgroundColor: '#d4edda', borderRadius: 5, paddingHorizontal: 6, paddingVertical: 3 },
