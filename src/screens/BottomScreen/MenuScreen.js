  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.toggleContainer}>
        <TouchableOpacity
          style={[styles.toggleButton, isVeg && styles.activeToggle]}
          onPress={() => setIsVeg(true)}
        >
          <MaterialCommunityIcons name="leaf" size={18} color={isVeg ? "white" : "#4CAF50"} />
          <Text style={[styles.toggleText, isVeg && { color: "white" }]}>Veg</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.toggleButton, !isVeg && styles.activeToggle]}
        ...
        >
          <MaterialCommunityIcons
            name="food-drumstick"
            size={18}
            color={!isVeg ? "white" : "#FF7043"}
          />
          <Text style={[styles.toggleText, !isVeg && { color: "white" }]}>Non-Veg</Text>
        </TouchableOpacity>
      </View>
