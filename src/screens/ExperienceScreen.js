...
const ExperienceScreen = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useSelector(state => state.nearestRestaurants);
...
const handleContinue = () => {
  if (selectedExperience && selectedRestaurant) {
    navigation.navigate('Bottom', {
      screen: 'HomeScreen', // <-- specify the nested screen
      params: {
    ...
    Alert.alert(
      'Selection Required',
      'Please select an experience and a restaurant.',
    );
  }
};
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <TouchableOpacity
            ...
            <View style={{flex: 1, marginLeft: 10}}>
              ...
              <Text style={styles.restaurantDetails}>
                Distance: {(res.distance / 1000).toFixed(2)} km | Rating:{' '}
                {res.rating}
              </Text>
            </View>
          </TouchableOpacity>
        ...
        <TouchableOpacity
          style={[
            ...
            (!selectedExperience || !selectedRestaurant) &&
              styles.disabledButton,
          ]}
          onPress={handleContinue}
          disabled={!selectedExperience || !selectedRestaurant}>
