...
const OderCartScreen = () => {
  ...
  const handleSaveNote = async () => {
    ...
    try {
      dispatch(updateNote({ cartKey: selectedItem.cartKey, note: noteText }));

      const resultAction = await dispatch(
        postCustomizedFood({
          food: selectedItem.foodId,
      ...
      <View style={styles.itemCard}>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.actionRow}>
            ...
            <TouchableOpacity style={styles.deleteBtn} onPress={() => deleteItem(item.cartKey)}>
        ...
        <View style={styles.quantityBox}>
          <TouchableOpacity
            style={styles.qtyBtn}
            onPress={() => decrementQty(item.cartKey)}>
          ...
          <TouchableOpacity
            style={styles.qtyBtn}
            onPress={() => incrementQty(item.cartKey)}>
            <Text style={styles.qtyText}>+</Text>
          </TouchableOpacity>
                ...
                <>
                  ...
                  <View style={[styles.bottomBar, { paddingBottom: insets.bottom || 10 }]}>
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                      ...
                      🛒 Ready to order! Tap "Continue" to checkout your delicious items.
